...
#define MOVE_CMD "mv "
		...
		sprintf(temp_dir_base, ".%stemp_ROBEX", PATH_SEPARATOR);
		...
		readerI->SetFileName(inputVolume.c_str());
		readerI->Update();
		...
		//readerAtlas->DisconnectPipeline();
	...
	/***********************************/
	   ...
	   /***********************************/
		...
		//TODO: Aqui esta o problema de fechar o Slicer!!! Ver como eh feita a leitura das imagens na pasta temp_
	   // gradients
	...
	/***********************************/
	   ...
	   /***********************************/
		...
		bool map2[200][200];
		bool map[200][200];
		double* xpp = new double[40000];
		double* ypp = new double[40000];
        ...
        while (readyM == false)
		{
            ...
            ballSize1.Fill(rad);
            ballSize2.Fill(rad + 2);
            kernel1.SetRadius(ballSize1);
            kernel2.SetRadius(ballSize2);
            kernel1.CreateStructuringElement();
            kernel2.CreateStructuringElement();


			padder->SetInput(V);
            MaskImageType::SizeType lpad, upad;
            lpad.Fill(50);
            upad.Fill(50);
		...
		readerI2->SetFileName(inputVolume.c_str());
		readerI2->Update();
		...
		finalWriter->SetFileName(outputVolume.c_str());
		finalWriter->Update();
